...
const Footer: React.FC<FooterProps> = ({ className }) => {
  return (
    <footer
      ...
      <div className="from-background/5 to-foreground/100 flex items-center justify-center gap-1 bg-linear-to-r from-1% to-91% bg-clip-text p-3 text-transparent transition-all duration-300 ease-linear hover:-skew-y-2 hover:gap-[6px]">

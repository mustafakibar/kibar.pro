...
const Footer: React.FC<FooterProps> = ({ className }) => {
  return (
    <footer
      ...
      <div className="from-13% to-91% flex flex-row items-center justify-center gap-1 bg-gradient-to-r from-background to-foreground bg-clip-text p-3 text-transparent transition-all duration-300 ease-linear hover:-skew-y-2 hover:gap-[6px]">

...
const Footer: React.FC<FooterProps> = ({ className }) => {
  return (
    <footer
      ...
      <div className="flex items-center justify-center gap-1 bg-gradient-to-r from-background/5 from-[1%] to-foreground/100 to-[91%] bg-clip-text p-3 text-transparent transition-all duration-300 ease-linear hover:-skew-y-2 hover:gap-[6px]">
